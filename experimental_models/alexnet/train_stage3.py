"""
Stage 3: Fine-tune with Focal Loss - AlexNet
...
def main():
    ...
    plt.title('Confusion Matrix - Stage 3 (Focal Loss) - AlexNet')
    plt.xlabel('Predicted'); plt.ylabel('True'); plt.tight_layout()
    plt.savefig(os.path.join(CONFIG["output_dir"], 'confusion_matrix_stage3.png'), dpi=150); plt.close()
    print(f"\nSTAGE 3 COMPLETE! - AlexNet | Model saved: output/best_model_stage3.keras")

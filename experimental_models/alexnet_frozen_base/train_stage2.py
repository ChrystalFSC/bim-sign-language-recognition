"""
Stage 2: Fine-Tuning Training - AlexNet (Frozen Base)
...
def main():
    print("\n" + "="*60 + "\nSTAGE 2: FINE-TUNING - AlexNet (Frozen Base)\nUnfreezing last 50%% of layers\n" + "="*60 + "\n")
    ...
    print(f"\nSTAGE 2 COMPLETE! - AlexNet (Frozen Base) | Best Val Acc: {max(history.history['val_accuracy'])*100:.2f}%% | Test Acc: {test_acc*100:.2f}%%")

"""
Stage 3.1: Terminal Learning Rate Squeeze - AlexNet (Frozen Base)
"""
...
def main():
    print("\n" + "="*60 + "\nSTAGE 3.1: THE LAST SQUEEZE - AlexNet (Frozen Base)\nAggressive Focal Loss (gamma=5.0)\n" + "="*60 + "\n")
    ...
    with open(os.path.join(CONFIG["output_dir"], 'per_class_performance_stage3_1.txt'), 'w') as f:
        f.write(f"STAGE 3.1 - PER-CLASS PERFORMANCE - AlexNet (Frozen Base)\n" + "="*70 + "\n")

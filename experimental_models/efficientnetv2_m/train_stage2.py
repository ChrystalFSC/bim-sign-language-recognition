"""
Stage 2: Fine-Tuning Training - EfficientNetV2-M
...
def main():
    print("\n" + "="*60 + "\nSTAGE 2: FINE-TUNING - EfficientNetV2-M\nUnfreezing last 50%% of layers\n" + "="*60 + "\n")
    ...
    print("\nStarting Stage 2 Training (Fine-Tuning) - EfficientNetV2-M\n")
    ...
    print(f"\nSTAGE 2 COMPLETE! - EfficientNetV2-M")

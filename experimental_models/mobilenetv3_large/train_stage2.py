"""
Stage 2: Fine-Tuning Training - MobileNetV3-Large
...
def main():
    print("\n" + "="*60 + "\nSTAGE 2: FINE-TUNING - MobileNetV3-Large\nUnfreezing last 50%% of layers\n" + "="*60 + "\n")
    ...
    print("\nStarting Stage 2 Training (Fine-Tuning) - MobileNetV3-Large\n")
    ...
    print(f"\nSTAGE 2 COMPLETE! - MobileNetV3-Large")

"""
Stage 3: Fine-tune with Focal Loss - MobileNetV3-Large
...
def main():
    ...
    plt.title('Confusion Matrix - Stage 3 (Focal Loss) - MobileNetV3-Large')
    plt.xlabel('Predicted'); plt.ylabel('True'); plt.tight_layout()
    plt.savefig(os.path.join(CONFIG["output_dir"], 'confusion_matrix_stage3.png'), dpi=150); plt.close()
    print(f"\nSTAGE 3 COMPLETE! - MobileNetV3-Large | Model saved: output/best_model_stage3.keras")

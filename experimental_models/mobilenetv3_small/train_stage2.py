"""
Stage 2: Fine-Tuning Training - MobileNetV3-Small
...
def main():
    print("\n" + "="*60 + "\nSTAGE 2: FINE-TUNING - MobileNetV3-Small\nUnfreezing last 50%% of layers\n" + "="*60 + "\n")
    ...
    print("\nStarting Stage 2 Training (Fine-Tuning) - MobileNetV3-Small\n")
    ...
    print(f"\nSTAGE 2 COMPLETE! - MobileNetV3-Small")

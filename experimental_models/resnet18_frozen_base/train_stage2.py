"""
Stage 2: Fine-Tuning Training - ResNet18 (Frozen Base)
...
def main():
    print("\n" + "="*60 + "\nSTAGE 2: FINE-TUNING - ResNet18 (Frozen Base)\nUnfreezing last 50%% of layers\n" + "="*60 + "\n")
    ...
    print(f"\nSTAGE 2 COMPLETE! - ResNet18 (Frozen Base) | Best Val Acc: {max(history.history['val_accuracy'])*100:.2f}%% | Test Acc: {test_acc*100:.2f}%%")

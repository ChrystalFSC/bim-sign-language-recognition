"""
Stage 1: Feature Extraction Training - VGG19
Only train the top classification layers while keeping VGG19 base frozen.
"""
import os
import numpy as np
...
def create_model():
    """Create model with FROZEN VGG19 base for feature extraction"""
...
def main():
    print("\n" + "="*60)
    print("STAGE 1: FEATURE EXTRACTION TRAINING - VGG19")
    ...
    print("Creating VGG19 model with frozen base...")
    model = create_model()
    ...
    print("\n" + "="*60)
    print("Starting Stage 1 Training (Feature Extraction) - VGG19")
    print("="*60 + "\n")
    ...
    print("\n" + "="*60)
    print(f"STAGE 1 COMPLETE! - VGG19")
